...
def run(
    ...
    cd = ChangeDetection(names) # added code
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            detected = [0 for i in range (len(names))] # added code
            p = Path(p)  # to Path
            ...
            cd.add(names, detected, save_dir, im0) # added code
