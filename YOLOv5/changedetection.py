...
class ChangeDetection :
    ...
    def __init__ (self, name) :
        ...
        self.result_prev = [0 for i in range (len(name))]
    ...
    def send (self, save_dir, image) :
        ...
        full_path = save_path / f"{0}-{1}-{2}-{3}.jpg".format(today.hour, today.minute, today.second, now.microsecond)
        ...
        res = requests.post(self.HOST + "/api_root/Post/", headers=headers, data=data, files=file)
